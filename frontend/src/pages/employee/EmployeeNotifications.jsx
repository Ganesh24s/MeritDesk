...
export default function EmployeeNotifications() {
  ...
  const markRead = async (n) => {
    try {
      ...
      // Redirect to workspace/tickets page where they can check ticket timeline/history
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-surface-500">View and respond to ticket assignments, SLA breaches, feedback, and system alerts.</p>
        </div>
        ...
        <div className="glass-card overflow-hidden divide-y divide-surface-200/50 dark:divide-surface-800/50">
          {displayedNotifications.length === 0 ? (
            <div className="text-center py-16 text-surface-400">
              ...
              <p className="text-sm">You have no notifications in this view.</p>
            </div>
          ) : (
